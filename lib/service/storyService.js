...
const storyService = {
    ...
    get_story: async function(req, res) {
        ...
        let m_id = 'gildong';   // verifyToken(req.cookies.accessToken).m_id;
    ...
    modify_confirm : async function(req, res) {
        ...
        */
        ...
        // let sql2 = `UPDATE TBL_STORY_PICTURE SET SP_IS_DELETED = 1 WHERE SP_PICTURE_NAME IN (arr)`;                                                                                    // 배열의 길이만큼 SP_PICTURE_NAME 추가, DELETE할 사진이 없으면 실행이 안돼야 함.
        ...
        try {
            ...
            if (modify1[0].affectedRows > 0) {
                ...
                sql2 = `UPDATE TBL_STORY_PICTURE SET SP_IS_DELETED = 1 WHERE SP_PICTURE_NAME = ? `;

                if (req.body.del !== undefined && req.body.del.length > 0) {
