...
const storyService = {
    ...
    modify_confirm : async function(req, res) {
        ...
        console.log('keepImg:', keepImg);

        // let post = {                                            // req.body;
        //     's_txt' : '1번스토리 이걸로 바뀌어야함!',
        //     's_is_public' : -1,
        //     's_no' : 1,
        // }
        ...
        //     {
        //         'sp_no' : 1,
        //         'sp_picture_name' : 'a.png'
        //     },
        //     {
        //         'sp_no' : 2,
        //         'sp_picture_name' : 'b.png'
        //     },
        //     {
        //         'sp_no' : 3,
        //         'sp_picture_name' : 'c.png'
        //     },
        //     {
        //         'sp_no' : 4,
        //         'sp_picture_name' : 'd.png'
        //     },
        //     {
        //         'sp_no' : 5,
        //         'sp_picture_name' : 'e.png'
        //     },
        // ]
        ...
        // let newImg = [
        //     {
        //         'sp_picture_name' : 'abc.png'
        //     },
        //     {
        //         'sp_picture_name' : 'abc.png'
        //     },
        //     {
        //         'sp_picture_name' : 'cc.png'
        //     },
        //     {
        //         'sp_picture_name' : 'dd.png'
        //     },
        //     {
        //         'sp_picture_name' : 'ee.png'
        //     },
        //     {
        //         'sp_picture_name' : 'ff.png'
        //     },
        //     {
        //         'sp_picture_name' : 'gg.png'
        //     },
        ...
        try {
            ...
            for (let d = 0; d < delImg.length; d++) {
                ...
                fs_extra.unlink(`${DEV_PROD_VARIABLE.STORY_PICTURES_DIR}${m_id}\\${delImg[d].sp_picture_name}`, (error) => {
                    if (error) {
                ...
                console.log('modify1 success!!');
                    ...
                    if (newImg.length <= delImg.length) {                   // 새로 추가되는 사진의 길이가 삭제되는 사진의 갯수보다 작거나 같은 경우
                        ...
                        for (let i = 0; i < newImg.length; i++) {
                            ...
                            let modify2 = await connection.query(sql2, [newImg[i].sp_picture_name, delImg[i].sp_picture_name]);
                            ...
                            if (completedQueries === newImg.length) {
                                ...
                                delImg.splice(0, newImg.length);
                                    ...
                                    for (let j = 0; j < delImg.length; j++) {
                                        ...
                                        let modify3 = await connection.query(sql3, [delImg[j].sp_picture_name]);
                            ...
                            let modify2 = await connection.query(sql2, [newImg[i].sp_picture_name, delImg[i].sp_picture_name]);
                                ...
                                try {
                                    ...
                                    for (let j = 0; j < newImg.length; j++) {
                                        ...
                                        let modify4 = await connection.query(sql4, [post.s_no, newImg[j].sp_picture_name]);
    ...
    // 스토리 수정 컨펌 (transaction 사용 => 다중 커넥션 사용)
    // 기존코드
    /*
    modify_confirm : async function(req, res) {                 
        printLog(DEFAULT_NAME, 'modify_confirm');
