...
const storyService = {
    ...
    */
    ...
    // 스토리 좋아요 버튼 눌렀을 시 좋아요 상태 업데이트 => 좋아요가 없는 게시글에 렌더링이 되지 않을 시 계속 좋아요를 누르면 누른만큼 카운트가 계속 올라감. (수정 전 기존코드)
    /*
    ...
    */
        ...
        // 스토리 좋아요 버튼 눌렀을 시 좋아요 상태 업데이트 => 좋아요가 없는 게시글에 렌더링이 되지 않을 시 계속 좋아요를 누르면 누른만큼 카운트가 계속 올라감.
        story_like_update: (req, res) => {
            printLog(DEFAULT_NAME, 'story_like_update');
