                ...
                if (g_member.length > 0) {
                    ...
                    // 정상 이용자
                        ...
                        const refreshToken = jwt.sign(
                            {
                                M_ID: g_member[0].M_ID,
                                M_NAME: g_member[0].M_NAME,
                                M_MAIL: g_member[0].M_MAIL,
                                M_PHONE: g_member[0].M_PHONE,
                                M_GENDER: g_member[0].M_GENDER,
                                M_SELF_INTRODUCTION: g_member[0].M_SELF_INTRODUCTION,
                                M_PROFILE_THUMBNAIL: g_member[0].M_PROFILE_THUMBNAIL,
                            },
                            DEV_PROD_VARIABLE.REFRESH_SECRET,
                            {
                                expiresIn: '30d',
                                    ...
                                    `, [id], (err4, insert_member) => {
                                        ...
                                        if(err4) {
                                            ...
                                            const refreshToken = jwt.sign(
                                                {
                                                    M_ID: insert_member[0].M_ID,
                                                    M_NAME: insert_member[0].M_NAME,
                                                    M_MAIL: insert_member[0].M_MAIL,
                                                    M_PHONE: insert_member[0].M_PHONE,
                                                    M_GENDER: insert_member[0].M_GENDER,
                                                    M_SELF_INTRODUCTION: insert_member[0].M_SELF_INTRODUCTION,
                                                    M_PROFILE_THUMBNAIL: insert_member[0].M_PROFILE_THUMBNAIL,
                                                },
                                                DEV_PROD_VARIABLE.REFRESH_SECRET,
                                                {
                                                    expiresIn: '30d',
