    ...
    */
    ...
    friend_request_confirm: async (req, res) => {
        ...
        try {
            ...
            let [insertResult] = await conn.query(insertFriendSql, [m_id, post.f_id, f_request_ilchon_name, post.f_id, m_id, f_response_ilchon_name]);

            if (insertResult.length > 0) {
                let [updateResult] = await conn.query(updateFriendRequestSql, [m_id, post.f_id]);
