...
const replyService = {
    ...
    reply_write_confirm: (req, res) => {
        ...
        let sql2 = `INSERT INTO TBL_REPLY(R_ORGIN_NO, R_OWNER_STORY_NO, R_TXT, R_M_ID) VALUES (?, ?, ?, ?)`;
    ...
    re_reply_write_confirm: (req, res) => {
        ...
        let sql1 = `INSERT INTO TBL_REPLY(R_ORGIN_NO, R_OWNER_STORY_NO, R_CLASS, R_TXT, R_M_ID) VALUES (?, ?, ?, ?, ?)`;

        DB.query(sql1, [post.r_orgin_no, post.r_owner_story_no, 1, post.r_txt, m_id], (error, result) => {
            if (error) {
